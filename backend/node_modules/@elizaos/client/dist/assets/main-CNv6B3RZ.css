...
@layer utilities {
  ...
  .grid-cols-\[minmax\(200px\,1fr\)_2fr_auto\] {
  ...
  :where(.divide-primary-foreground\/30 > :not(:last-child)) {
    border-color: hsl(var(--primary-foreground));
  }

  @supports (color: color-mix(in lab, red, red)) {
    :where(.divide-primary-foreground\/30 > :not(:last-child)) {
      border-color: color-mix(in oklab, hsl(var(--primary-foreground)) 30%, transparent);
    }
  }
  ...
  .\[animation-delay\:0ms\], .\[animation-delay\:0s\] {
    animation-delay: 0s;
  }
  ...
  .group-data-\[state\=active\]\:text-current:is(:where(.group)[data-state="active"] *) {
    color: currentColor;
  }

  .group-data-\[variant\=floating\]\:rounded-md:is(:where(.group)[data-variant="floating"] *) {
    border-radius: calc(var(--radius)  - 2px);
  }
  ...
  @media (hover: hover) {
    ...
    .hover\:bg-muted:hover, .hover\:bg-muted\/10:hover {
      background-color: hsl(var(--muted));
    }
    ...
    .hover\:bg-sidebar-accent:hover, .hover\:bg-sidebar-accent\/80:hover {
      background-color: hsl(var(--sidebar-accent));
    }

    @supports (color: color-mix(in lab, red, red)) {
      .hover\:bg-sidebar-accent\/80:hover {
        background-color: color-mix(in oklab, hsl(var(--sidebar-accent)) 80%, transparent);
      }
    }
    ...
    .group-data-\[collapsible\=offcanvas\]\:hover\:bg-card:is(:where(.group)[data-collapsible="offcanvas"] *):hover {
      background-color: hsl(var(--card));
    }
  ...
  .focus-visible\:ring-red-400\/20:focus-visible {
  ...
  .has-\[\[data-variant\=inset\]\]\:bg-card:has([data-variant="inset"]) {
    background-color: hsl(var(--card));
  }
  ...
  .data-\[state\=checked\]\:translate-x-\[calc\(100\%\+10px\)\][data-state="checked"] {
  ...
  .data-\[state\=unchecked\]\:\!bg-gray-500\/80[data-state="unchecked"] {
    background-color: #6a7282cc !important;
  }

  @supports (color: color-mix(in lab, red, red)) {
    .data-\[state\=unchecked\]\:\!bg-gray-500\/80[data-state="unchecked"] {
      background-color: color-mix(in oklab, var(--color-gray-500) 80%, transparent) !important;
    }
  }
  ...
  .data-\[variant\=destructive\]\:font-normal[data-variant="destructive"] {
    --tw-font-weight: var(--font-weight-normal);
    font-weight: var(--font-weight-normal);
  }
  ...
  @media (min-width: 48rem) {
    ...
    .md\:grid-cols-\[minmax\(200px\,1fr\)_2fr_auto\] {
      grid-template-columns: minmax(200px, 1fr) 2fr auto;
    }
  ...
  .dark\:bg-orange-950\/60:is(.dark *) {
    background-color: #44130699;
  }

  @supports (color: color-mix(in lab, red, red)) {
    .dark\:bg-orange-950\/60:is(.dark *) {
      background-color: color-mix(in oklab, var(--color-orange-950) 60%, transparent);
    }
  }
  ...
  .dark\:bg-sky-950\/60:is(.dark *) {
    background-color: #052f4a99;
  }
  ...
  .dark\:bg-yellow-950\/60:is(.dark *) {
    background-color: #43200499;
  }

  @supports (color: color-mix(in lab, red, red)) {
    .dark\:bg-yellow-950\/60:is(.dark *) {
      background-color: color-mix(in oklab, var(--color-yellow-950) 60%, transparent);
    }
  }
  ...
  @media (hover: hover) {
    .dark\:hover\:border-gray-700:is(.dark *):hover {
  ...
  .dark\:focus-visible\:ring-red-500:is(.dark *):focus-visible {
    --tw-ring-color: var(--color-red-500);
  }

  .dark\:data-\[state\=active\]\:border-muted:is(.dark *)[data-state="active"] {
    border-color: hsl(var(--muted));
  }

  .dark\:data-\[state\=active\]\:bg-gray-600:is(.dark *)[data-state="active"] {
    background-color: var(--color-gray-600);
  }

  .dark\:data-\[state\=active\]\:text-gray-200:is(.dark *)[data-state="active"] {
    color: var(--color-gray-200);
  }

  .dark\:data-\[state\=active\]\:shadow-none:is(.dark *)[data-state="active"] {
    --tw-shadow: 0 0 #0000;
    box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);
  }
  ...
  .dark\:data-\[state\=unchecked\]\:bg-primary-foreground:is(.dark *)[data-state="unchecked"] {
    background-color: hsl(var(--primary-foreground));
  }
  ...
  @supports (color: color-mix(in lab, red, red)) {
    .dark\:data-\[variant\=destructive\]\:focus\:bg-destructive\/40:is(.dark *)[data-variant="destructive"]:focus {
      background-color: color-mix(in oklab, hsl(var(--destructive)) 40%, transparent);
    }
  }
  ...
  .\[data-testid\=\"app-sidebar\"\]\:visible:is() {
    visibility: visible;
  }
